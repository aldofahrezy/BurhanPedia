...
async function predict() {
    ...
    try {
        ...
        // Contoh: const motiveLabels = ["Motive A", "Motive B", ...];
        // const predictedLabel = motiveLabels[predictedClassIndex];

        predictionResult.innerHTML = `
            Prediksi Selesai!<br>
            Probabilitas untuk 15 motives:<br>
            ${JSON.stringify(Array.from(predictionArray), null, 2)}<br>
            Motive Paling Dominan (Indeks): ${predictedClassIndex} dengan Probabilitas: ${maxProb.toFixed(4)}
        `;
